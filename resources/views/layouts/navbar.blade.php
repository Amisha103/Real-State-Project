            ...
            <ul class="navbar-nav mx-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="text-white dropdown-menu bg-transparent" aria-labelledby="pagesDropdown">
                        <li><a class=" blur-background text-white dropdown-item" href="#">See Properties</a></li>
                        <li><a class=" blur-background text-white dropdown-item" href="#">Buy Properties</a></li>
                        <li><a class=" blur-background text-white dropdown-item" href="#">Blogs</a></li>
                    </ul>
                </li>
                <li class="nav-item">
