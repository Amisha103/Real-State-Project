<footer>
    <div class="container-fluid footer_div col-md-12 align-items-center">
        <div class="container-fluid logos mx-auto col-md-6 d-flex justify-content-center">
            <a class="d-flex justify-content-center col-4 col-md-2" target="_blank" href="https://www.facebook.com/profile.php?id=100079941048298"><i class="d-flex text-white justify-content-center mt-5 col-md-2 fs-1 fa-brands fa-facebook"></i></a>
...
<script src="{{ asset('js/wordCount.js') }}"></script>
