<!-- resources/views/land_for_sale/index.blade.php -->
...
<head>
    ...
    <title>Land For Sale Data</title>
...
<body>
    <div class="all_main_div">
        <h1 class="mb-4 text-center mt-3">Lands For Sale</h1>
        <div class="row text-dark">
            @foreach($landForSaleData as $data)
            <div class="col-md-6">
