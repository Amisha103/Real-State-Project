...
<body>
    ...
    <div class="add_sales_div text-white container">
        ...
        <h1 class="text-center mt-3">Add Flates Data</h1>
        ...
        <div class="form_div container mb-4">
            <form action="{{URL::to('add-flat-data')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" value="Flat" class="text-white bg-dark form-control mb-4" id="type" name="type" required>
                </div>
                <div class="form-group">
                ...
                <button type="submit" name="addFlatData" class="btn btn-primary mt-3 fs-5">Add</button>
            </form>
        </div>
    </div>