...
<body>
    ...
    <div class="add_sales_div text-white container">
        ...
        <h1 class="text-center mt-3">Add Lands Data</h1>
        ...
        <div class="form_div container mb-4">
            <form action="{{URL::to('add-land-data')}}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" value="Land" class="text-white bg-dark form-control mb-4" id="type" name="type" required>
                </div>
                <div class="form-group">
